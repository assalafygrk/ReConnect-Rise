...
import { ShieldCheck, ArrowRight, User, Smartphone, Lock } from 'lucide-react';
...
export default function MockRegisterPage() {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-[#0B1221] px-4 relative overflow-hidden py-20">
            ...
            <div className="relative w-full max-w-md">
                <div className="bg-[#1A2235]/60 backdrop-blur-3xl rounded-[2.5rem] p-8 md:p-12 border border-white/10 shadow-2xl relative">
                    ...
                    <div className="text-center mb-10">
                        ...
                        <h2 className="text-3xl font-black text-white mb-2 font-serif">Join Us</h2>
                        <p className="text-white/40 text-sm font-medium">Create your utility account today</p>
                    </div>
                    ...
                    <div className="mt-8 text-center">
                        <p className="text-white/40 text-xs font-medium">
                            ...
                            <Link to="/mock-login" className="text-[#3B82F6] font-bold hover:underline">
                                Login Here
                            </Link>
                        </p>
                    </div>
                    ...
                    <div className="mt-8 pt-8 border-t border-white/5 flex items-center justify-center gap-2 text-[10px] font-black uppercase tracking-widest text-white/20">
                        <ShieldCheck size={14} className="text-green-500" /> Instant Account Activation
                    </div>
                </div>
            </div>
        </div>
